...
function combineJS() {
    return src(['src/js/vendor/jquery.min.js', 'src/js/vendor/owl.carousel.min.js', 'src/js/vendor/wow.min.js', 'src/js/function.js'])
        .pipe(concat('main.js'))
        .pipe(dest('src/js'))
        .pipe(browserSync.stream());
}
...
exports.build = series(parallel(cssMinify, minifyJS, replaceLink), image);
